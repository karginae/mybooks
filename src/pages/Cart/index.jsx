        ...
        <div className={styles.cart}>
          {cartBooks?.length === 0 ? null :
            <div className={styles.actions}>
              ...
              <Link to='/order'><div className={styles.toOrder}>К оформлению заказа</div></Link>
            </div>
          }
          {
              ...
              <article className={styles.cartItem} key={index}>
                <div className={styles.cartBook}>
                  <Link to={`/${cartBook.book._id}`}>
                    <img className={styles.bookCover} src={`${axios.getUri()}/covers/${cartBook.book.cover}`} alt="book" />
                  </Link>
                </div>
                <ul className={styles.infoBook}>
                  ...
                  <li className={styles.age_limit}>Возрастное ограничение: {cartBook.book.age_limit}+</li>
                </ul>
